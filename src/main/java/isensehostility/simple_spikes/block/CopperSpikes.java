...
public class CopperSpikes extends Block implements Spike {
    public CopperSpikes() {
        super(Properties.copy(Blocks.COPPER_BLOCK).requiresCorrectToolForDrops());
    }

    @Override
    public SimpleSpikes.SpikeTypes getType() {
        return SimpleSpikes.SpikeTypes.COPPER;
    }
